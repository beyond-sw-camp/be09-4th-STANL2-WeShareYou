...
CREATE TABLE board (
                       ...
                       board_image_url JSON NULL COMMENT 'AWS S3를 통해서 이미지 업로드 및 저장',
...
INSERT INTO board (board_title, board_content, board_image_url, board_tag, board_comment_count, board_likes_count, board_created_at, board_updated_at, board_active, member_id) VALUES
                                                                                                                                                                                   ('Guide to Paris', 'A detailed guide to traveling in Paris.',
                                                                                                                                                                                    '["https://weshareubk.s3.ap-northeast-2.amazonaws.com/1a2b3c4d-5678-1234-9abc-def4567890ab.png", "https://weshareubk.s3.ap-northeast-2.amazonaws.com/9f8e7d6c-1234-5678-abcd-9876bc543210.jpeg", "https://weshareubk.s3.ap-northeast-2.amazonaws.com/abcd1234-5678-90ab-cdef-1234567890ff.png"]',
                                                                                                                                                                                    'GUIDE', 0, 0, '2024-10-08T12:00:00', '2024-10-08T12:00:00', TRUE, 1),
                                                                                                                                                                                   ('Selling Camping Gear', 'Selling my used camping gear at a good price.',
                                                                                                                                                                                    '["https://weshareubk.s3.ap-northeast-2.amazonaws.com/0f1e2d3c-9876-5432-bacd-6543df1098ab.png", "https://weshareubk.s3.ap-northeast-2.amazonaws.com/1234abcd-5678-9876-cdef-876543210fff.jpeg", "https://weshareubk.s3.ap-northeast-2.amazonaws.com/5678abcd-90ab-1234-cdef-abcdef123456.png"]',
                                                                                                                                                                                    'FREEMARKET', 0, 0, '2024-10-08T12:00:00', '2024-10-08T12:00:00', TRUE, 2),
                                                                                                                                                                                   ('Looking for Travel Companion', 'Looking for a companion for a trip to Spain.',
                                                                                                                                                                                    '["https://weshareubk.s3.ap-northeast-2.amazonaws.com/3456abcd-7890-9876-cdef-ffedcba09876.png", "https://weshareubk.s3.ap-northeast-2.amazonaws.com/4567abcd-1234-7890-defa-aaaa12345678.jpeg", "https://weshareubk.s3.ap-northeast-2.amazonaws.com/9876dcba-4321-5678-bacd-987654321abc.png"]',
                                                                                                                                                                                    'ACCOMPANY', 0, 0, '2024-10-08T12:00:00', '2024-10-08T12:00:00', TRUE, 3);
