    ...
    <div class="signup-page">
        ...
        <div class="signup-box">
            ...
            <div class="input-group with-button">
                <input v-model="loginId" id="loginId" type="email" placeholder="이메일 형식의 아이디를 입력해 주세요." required />
            ...
            <div class="input-group">
                ...
                <input v-model="password" id="password" type="password" placeholder="비밀번호를 입력해 주세요." @input="validatePasswordMatch" required />
            </div>
            ...
            <div class="input-group">
                ...
                <input v-model="confirmPassword" id="confirmPassword" type="password" placeholder="비밀번호를 한번 더 입력해 주세요." @input="validatePasswordMatch" required />
